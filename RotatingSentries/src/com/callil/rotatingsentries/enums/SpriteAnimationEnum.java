...
public enum SpriteAnimationEnum {
	...
	ENEMY_NINJA_APPEAR(new int[]{0,1,2,3,4,4,4,4,4,4,4,4,4}, 100),
	ENEMY_NINJA_APPEAR_END(new int[]{5,6,7,8,9,10}, 100),
	ENEMY_NINJA_THROW(new int[]{11,12,13,14}, 75),
	ENEMY_NINJA_THROW_RECOVERY(new int[]{15,7,8,9,10}, 100),
